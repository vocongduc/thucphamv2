        ...
        <div class="container-fluid">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header">
                    <a style="text-align: left" href="{{route('menu.createCate')}}" class="btn btn-success">Thêm thể
                        loại</a>
                    <a style="text-align: right;" href="{{route('menu.index')}}" class="btn btn-primary">Danh sách</a>
                </div>
