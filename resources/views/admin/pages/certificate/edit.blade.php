        ...
        <div class="container-fluid">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Sửa chứng nhận</li>
                </ol>
            </section>
            <br>
            <div class="box box-primary">
                ...
                <form role="form" method="POST" action="{{url('admincp/certificate/edit/'.$certificate->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">

                        <div class="form-group">
                            <img width="100px" src="assets/img_certificate/{{$certificate->image}}">
                        </div>
