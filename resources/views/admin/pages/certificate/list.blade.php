        ...
        <div class="container-fluid">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">giấy chứng nhận</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <a href="{{route('certificate.create')}}" class="btn btn-success">Thêm giấy chứng nhận</a>
                            </div>
                            <div class="box-header">
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($certificate as $value)
                                        <tr class="odd gradeX" align="center">
                                            <td><img width="100px" src="assets/img_certificate/{{$value->image}}"></td>
                                            <td>
                                                {{--<a class="btn btn-primary" id="bt{{$value->id}}" style="display: block" onclick="thaotac({{$value->id}})" >Thao tác</a>--}}
                                                <div id="button{{$value->id}}">

                                                    <a class="btn btn-success"
                                                       href="{{url('admincp/certificate/show/'.$value->id)}}"> Xem</a>
                                                    <a class="btn btn-success"
                                                       href="{{url('admincp/certificate/edit/'.$value->id)}}"> Sửa</a>
                                                    <a class="btn btn-danger"
                                                       href="{{ url('admincp/certificate/destroy/'.$value->id) }}"
