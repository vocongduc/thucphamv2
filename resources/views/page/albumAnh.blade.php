        ...
        <div class="content">
            <div class="content-head">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Album ảnh</a></li>
                </ul>
            </div>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="album-anh">
                                <a href="">
                                    <img src="{{asset('images/hanh/kinh_doanh_an_toan.jpg')}}"><br>
                                    <small>Thứ 5, 01/02/18, 12:02</small>
                                    <div class="image-content">
                                        <h6>BigGreen đóng góp tích cực vào hiệu quả của Đề án Trái cây an toàn của thành
                                            phố Hà Nội</h6>
                                        <p>Dâu tây giống New Zealand là một trong những giống Dâu tây nổi tiếng trên thế
                                            giới. Tuy mới được du nhập vào Đà Lạt - Việt Nam trong thời gian ngắn nhưng
                                            Dâu tây Giống New Zealand đã trở thành Giống Dâu tây cao cấp được người
                                            trồng và người sử dụng ưa chuộng nhất hiện nay.</p>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="album-anh">
                                <a href="">
                                    <img src="{{asset('images/hanh/kinh_doanh_an_toan.jpg')}}" style="width:269px"><br>
                                    <small>Thứ 5, 01/02/18, 12:02</small>
                                    <div class="image-content">
                                        <h6>CEO Syngenta thăm cửa hàng BigGreen</h6>
                                        <p>Dâu tây giống New Zealand là một trong những giống Dâu tây nổi tiếng trên thế
                                            giới. Tuy mới được du nhập vào Đà Lạt - Việt Nam trong thời gian ngắn nhưng
                                            Dâu tây Giống New Zealand đã trở thành Giống Dâu tây cao cấp được người
                                            trồng và người sử dụng ưa chuộng nhất hiện nay.</p>
                        ...
                        <div class="col-md-4">
                            <div class="album-anh">
                                <a href="">
                                    ...
                                    <small>Thứ 5, 01/02/18, 12:02</small>
                                    <div class="image-content">
                                        <h6>Biggreen Thái Thịnh nhận biển nhận diện kinh doanh trái cây an toàn của UBND
                                            TPHN, Quận Đống Đa và Sở công thương</h6>
                                        <p>Dâu tây giống New Zealand là một trong những giống Dâu tây nổi tiếng trên thế
                                            giới. Tuy mới được du nhập vào Đà Lạt - Việt Nam trong thời gian ngắn nhưng
                                            Dâu tây Giống New Zealand đã trở thành Giống Dâu tây cao cấp được người
                                            trồng và người sử dụng ưa chuộng nhất hiện nay.</p>
