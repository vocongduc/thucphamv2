            ...
            <div class="content">
                <div class="content-head">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Đối tác chiến lược</a></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-md-8">
                                        ...
                                        <div class="content-left-text">
                                            ...
                                            {{--<div class="float-right">--}}
                                                {{--<button type="button" class="btn btn-primary btn-sm"--}}
                                                        {{--style="font-size: 10px;border: none"><i--}}
                                            ...
                                            <div>
                                                <strong>Địa chỉ: </strong>{{$value->address}}<br>
                                                <strong>Phone: </strong>{{$value->phone}}<br> <strong>Fax:</strong> {{$value->fax}}
                                            </div>
                                            <div class="brief"><p><span style="font-size:16px;"><span
                                                                style="font-family:Arial, Helvetica, sans-serif;"><strong>{!! $value->summary !!}</strong></span></span>
                                                </p>
                                                {!! $value->content !!}
                                                <div class="clearfix"></div>
