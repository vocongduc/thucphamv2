        ...
        <div class="content">
            <div class="content-head">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Truyền thông báo chí</a></li>
                                ...
                                <div class="col-md-6">
                                    <div class="thumbnail">
                                        <a href="{{ route('tin-tuc-chi-tiet') }}">
                                            <img src="https://biggreen.vn/publish/thumbnail/20366/400x267xdefault/upload/20366/20190114/48982029_1628211580612408_5496795047745552384_n.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="discription">
                                        <h6>
                                            <a href="{{ route('tin-tuc-chi-tiet') }}">Sinh
                                                tố lá hẹ, củ sen bồi bổ cơ thể, phòng chống ung thư</a>
                                        </h6>
                                        <small>
                                            <i class='far fa-calendar-alt'></i>
                                            &nbsp;(Ngày: 23/06/2018)
                                        </small>
                                        <p>Sinh tố lá hẹ và củ sen có tác dụng vừa bồi bổ cơ thể,
                                            an thần, chống suy nhược, vừa được coi là một trong những bài
                                            thuốc phòng chống ung thư hữu hiệu.
                                        </p>
                                        <a href="{{ route('tin-tuc-chi-tiet') }}"
                        ...
                        <div class="content-left-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div>
                                        <h6>
                                            <a href="{{ route('tin-tuc-chi-tiet') }}">Sinh tố lá hẹ, củ sen bồi bổ cơ thể, phòng chống ung thư</a>
                                        </h6>
                                        <small><i class='far fa-calendar-alt'></i> &nbsp;(Ngày:
                                            23/06/2018)</small>
                                        <p>Sinh tố lá hẹ và củ sen có tác dụng vừa bồi bổ cơ thể,
                                            an thần, chống suy nhược, vừa được coi là một trong những bài
                                            thuốc phòng chống ung thư hữu hiệu.</p>
                                            <a href="{{ route('tin-tuc-chi-tiet') }}"
                                            class="btn btn-outline-success btn-sm">
                                            Đọc tiếp >>
                                        </a>
